...
stories.add(
  ...
  () => (
    <ResponsiveMedia ratio={9 / 16}>
      <img src="https://via.placeholder.com/800x450?text=16:9%20ratio" alt="" />
    </ResponsiveMedia>
  ),
  {
    info: {
...
stories.add('with image', () => (
  <div style={{ border: '10px solid #aaa' }}>
    <ResponsiveMedia ratio={2 / 4}>
      <img src="https://via.placeholder.com/1200x600?text=4:2%20ratio" alt="" />
    </ResponsiveMedia>
  </div>
))
...
stories.add('with video', () => (
  <div style={{ border: '10px solid #aaa' }}>
    <ResponsiveMedia ratio={9 / 16}>
      ...
      <video
        controls
        poster="https://via.placeholder.com/800x450?text=16:9%20ratio"
